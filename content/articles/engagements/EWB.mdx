export const meta = {
  ...
  description:
    "My experience working with the Engineers Without Borders student chapter during college.",
};
...
https://youtube.com/watch?v=rtTc8N6SGns
...
superstructure and wing walls as seen in the embedded video that I
created.
