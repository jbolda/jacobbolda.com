export const meta = {
  ...
  slug: "/STEMonFire/",
  category: "podcast",
  description: "Guest on the STEM on Fire podcast.",
};

### [STEM on Fire Guest](https://stemonfire.com/43-architectural-and-structural-engineer-jacob-bolda/)

#### Guest Representing the AEC Industry
