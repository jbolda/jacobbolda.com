export const meta = {
  ...
  category: "education",
  description:
    "A bit about my master's thesis and a link for those interested in reading further.",
};
...
The purpose of my capstone design project report was to discuss
the behavior of a hooked bar in concrete carrying a tension force. The cover
