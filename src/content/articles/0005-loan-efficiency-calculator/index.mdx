...
tags:
  - finance
description: >-
  This calculator assists in running the numbers on loan overpayment and how
  that affects your interest paid and time to final payment.
---

import LoanCalculator from "~/components/article-components/loan-calculator.jsx";
