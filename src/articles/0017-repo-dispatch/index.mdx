...
description: "Github Actions repository dispatch is a way to trigger a build via an external system."
---
...
For this specific example, I am deploying my site on Netlify. The Netlify CLI very recently [had their CLI added to the runner](https://github.com/actions/virtual-environments/pull/1423). This means we don't need to install it and it will save us some time on the build. Depending on your site content or configuration, you need to install your dependencies, build your site and then you can use `netlify` to deploy it.
